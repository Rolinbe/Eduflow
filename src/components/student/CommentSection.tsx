            ...
            {replyTo === comment.id && (
              <div className="mt-3 flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-primary-500 text-white text-sm font-medium rounded-lg hover:bg-primary-600 disabled:opacity-50"
                >
              ...
              <div className="mt-3 ml-8 space-y-3 border-l-2 border-gray-100 pl-4">
                {comment.replies.map((reply) => (
                  <div key={reply.id}>
                    ...
                    <p className="text-sm text-gray-600 mt-1 ml-8">{reply.content}</p>
                  </div>
                ))}
              </div>
            )}
