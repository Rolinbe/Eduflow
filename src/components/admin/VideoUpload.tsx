...
export default function VideoUpload({ coursId, onSuccess }: VideoUploadProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      await api.post(`/admin/cours/${coursId}/videos`, formData, {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        {file ? (
          <div>
            <span className="material-symbols-outlined text-3xl text-primary-500">video_file</span>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-2">Cliquez pour sélectionner une vidéo</p>
